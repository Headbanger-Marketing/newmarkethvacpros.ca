...
# ============================================================ DEPRECATED
"""Content + page assembly for newmarkethvacpros.ca. Run: python3 build_pages.py"""
...
SVC = {
 "furnace-repair": {
   ...
   "intro":"When your furnace stops working, you need fast, dependable service you can trust. At Newmarket HVAC Pros, we provide expert furnace repair in Newmarket, Ontario and surrounding York Region communities to restore warmth, safety, and efficiency to your home. Our skilled technicians quickly diagnose issues and deliver lasting repairs, helping you stay comfortable through every cold Ontario winter.",
   ...
   "problem_p":"Newmarket HVAC Pros provides expert furnace repair in Newmarket, ON to keep homes warm, safe, and efficient through the coldest months.",
   "features":[
 ...
 "ac-repair": {
   ...
   "problem_p":"Newmarket HVAC Pros provides expert AC repair in Newmarket, ON for central air, ductless mini-splits, and high-efficiency systems.",
   "features":[
 ...
 "ductless-ac-installation": {
   ...
   "intro":"Experience reliable, energy-efficient cooling with professional ductless AC installation from Newmarket HVAC Pros. Serving Newmarket, Ontario and surrounding York Region areas, our expert technicians install high-performance ductless air conditioning systems that provide customizable comfort year-round. Ideal for homes without traditional ductwork, our solutions deliver quiet, efficient cooling while helping you save on energy costs.",
   ...
   "problem_p":"Newmarket HVAC Pros provides ductless AC installation for efficient, flexible cooling that reduces energy costs and keeps every room comfortable.",
   "features":[
 ...
 "heat-pump-repair-installation": {
   ...
   "intro":"For reliable heat pump repair and installation in Newmarket, Ontario, trust the experienced team at Newmarket HVAC Pros. We provide expert heat pump services designed to keep your home efficient and comfortable in every season, from cold winters to hot, humid summers. Whether you need fast repairs, routine maintenance, or a new energy-efficient system, our skilled technicians deliver dependable solutions.",
   ...
   "problem_p":"Newmarket HVAC Pros provides expert heat pump repair and installation in Newmarket, Ontario for reliable year-round comfort and lower energy bills.",
   "features":[
 ...
 "fireplace-installation": {
   ...
   "intro":"Enhance your home's warmth and style with professional fireplace installation from Newmarket HVAC Pros. Serving Newmarket, Ontario and surrounding York Region areas, our skilled team ensures safe, efficient, and beautiful installations that complement any space. From modern gas units to classic wood-burning fireplaces, we provide expert guidance and quality workmanship to create a cozy, inviting atmosphere.",
   ...
   "problem_p":"Newmarket HVAC Pros provides professional fireplace installation, ensuring safe, efficient, code-compliant fireplaces beautifully integrated into your home.",
   "features":[
 ...
 "thermostat-repair-replacement": {
   ...
   "intro":"Stay in control of your home's comfort with professional thermostat repair and replacement from Newmarket HVAC Pros. We provide expert thermostat services in Newmarket, Ontario and surrounding York Region areas, ensuring accurate temperature control, improved energy efficiency, and reliable system performance. Whether you need a quick repair, a smart-thermostat upgrade, or a full replacement, our technicians deliver dependable solutions.",
...
SVC_PHOTO_FALLBACK = ("wp/Newmarket-Ontario-HVAC-technician.png", "Newmarket HVAC Pros HVAC technician in service")
SVC_PHOTO = {
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>Newmarket HVAC Pros, {data["h1"]}</h1>
    <p>{data["intro"]}</p>
...
def build_home():
    ...
    out = head(
      ...
      desc=f"Newmarket HVAC Pros provides honest, efficient, dependable HVAC service in {CITY}, Ontario, furnace & AC repair, heat pumps & more. Call {PHONE_DISPLAY} for a free quote.",
      path="/",
...
<section class="{hero_class()}">
  ...
  <div class="container">
    <div class="hero__copy reveal">
      ...
      <h1>Newmarket HVAC Pros, Expert Heating &amp; Cooling Repair in <span class="accent">{CITY}, ON</span></h1>
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p class="lead">At Newmarket HVAC Pros, we understand that a broken air conditioner or failing furnace is more than an inconvenience, it's a disruption to your life.</p>
      ...
      <div class="split__media reveal d1">
        <img class="media-photo" src="/assets/img/wp/Newmarket-Ontario-HVAC-technician.png" alt="Newmarket HVAC Pros HVAC technician servicing a system" width="640" height="640" loading="lazy" decoding="async">
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2>Why Choose Newmarket HVAC Pros?</h2>
...
def build_about():
    out = head(
      ...
      desc=f"Newmarket HVAC Pros is a local, family-run HVAC company serving Newmarket, Ontario with honest, reliable heating and cooling care. Meet the team.",
      path="/about/",
  ...
  <div class="container">
    <div class="split">
      <div class="reveal">
        ...
        <p>At Newmarket HVAC Pros, we believe every family deserves a comfortable, healthy home. As a family-oriented business based in Newmarket, Ontario, our mission is simple: keep your home comfortable through every season with the same high standard of care we'd expect for our own households.</p>
...
{cta_band(title="Experience the Newmarket HVAC Pros Difference",
...
def build_contact():
    out = head(
      ...
      desc=f"Contact Newmarket HVAC Pros for fast, friendly HVAC service in Newmarket, Ontario. Call {PHONE_DISPLAY} or request a free quote online. Open 24/7.",
      path="/contact/",
...
<section class="page-hero">
  <div class="container">
    ...
    <p>Is your air conditioner making a strange noise? Ready to upgrade your furnace before winter? Whatever your home comfort need, the Newmarket HVAC Pros team is ready to help, without the stress.</p>
  </div>
</section>
...
<p>At Newmarket HVAC Pros, we often hear the same question: <em>how often should I service my heating and cooling system?</em> Our answer is simple. At minimum, twice per year.</p>
...
<h2>Book Your Service With Newmarket HVAC Pros</h2>
...
def build_privacy():
    out = head(title=f"Privacy Policy | {SITE_NAME}",
      desc="Privacy policy for Newmarket HVAC Pros, how we collect, use, and protect your personal information.",
      path="/privacy-policy/",
...
def build_root_files():
    write_root("CNAME", "newmarkethvacpros.ca\n")
